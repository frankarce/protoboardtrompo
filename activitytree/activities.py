...
'/activity/cicloagua': u""" Un himno es una composición poética o musical de tono solemne que representa y ensalza a una organización o un país y en cuyo honor se interpreta en actos públicos. """,
...
'/test/testcicloagua':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Cual es el otro nombre con el cual se le conoce al ciclo del agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Ciclo del agua.","Ciclo hidrológico.","Ciclo energetico.","Ciclo de la vida"],
                    'answer': [0,1,0,0],
                    'answer_text': "Una sustancia",
                    'hints': ["", ""]
                    },
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿De que trata el ciclo del agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["se denomina al continuo intercambio de agua dentro de la hidrosfera, entre la atmósfera, el agua superficial y subterránea y los organismos vivos. ","Son los cambios de estado de la materia.","Es un metodo de obtencion de agua.","Es el ciclo de la vida "],
                    'answer': [1,0,0,0],
                    },
                    {
                    'id':1322,
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Que procesos ocurren en el ciclo del agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Energetico y Sustentable.","Fermentacion y Licuefaccion.","Liquido, Solido y Gaseoso.","Evaporacion, Precipitacion y Escorrentia."],
                    'answer': [0,0,0,1],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
...
'/test/testenergia':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Como se denomina a la energia generada con el agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Que tipo de energia es esta?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Energia azul.","Energia verde.","Energia roja.","Energia amarilla."],
                    'answer': [0,1,0,0],
                    },
                    {
                    'id':1322,
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Debido a que esta energia es inagotable?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Al ciclo del agua.","A que hay mucha agua.","A que el agua es azul.","A que la energia se transforma."],
                    'answer': [1,0,0,0],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
...
'/test/testcantidad':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Que porcentaje de la superficie de la tierra esta cubierta por agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["10%","20%","71%","60%"],
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿De esa agua que porcentaje de agua es salada?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["10%","96.5%","15.6%","1.2%"],
                    'answer': [0,1,0,0],
                    },
                    {
                    'id':1322,
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Y del 3.5% del agua dulce donde se ubica?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Se encuentra a nivel superficial en forma de ríos y arroyos, a nivel subterráneo en forma de acuíferos naturales, y en forma de hielo en los polos y cimas de montañas.","Se encuentra en la atmosfera.","En el hielo de las montañas","Bajo tierra."],
                    'answer': [1,1,1,1],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
...
'/test/testmateria':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Cuales son los 3 estados de la materia?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Solido, Liquido y Gaseoso","Amarillo, Azul y Rojo","Legislativo, Ejecutivo y Judicial","Hugo, Paco y Luis"],
                    'answer': [1,0,0,0],
                    'answer_text': "Una sustancia",
                    'hints': ["", ""]
                    },
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Como se encuentran los atomos en el estado solido?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Estan fuertemente unidos","Estan dispersos","No estan","Se repelen"],
                    'answer': [1,0,0,0],
                    },
                    {
                    'id':1322,
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Como se encuentran los atomos en el estado Gaseoso?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Se encuentran ligeramente unidos","Se encuentran muy unidos.","Se encuentran muy dispersos","Se atraen."],
                    'answer': [1,1,1,1],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
...
'/test/testsalud':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Como ayuda a la sangre el agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Ayuda a mantener su volumen","A generar mas sangre","A que no se acabe"],
                    'answer': [1,0,0],
                    'answer_text': "Una sustancia",
                    'hints': ["", ""]
                    },
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Crees que el agua ayude a bajar de peso?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Si","No"],
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Porque el agua te ayuda cuando estas enfermo y tomas algun medicamento?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Ayuda a diluir y dispersar las medicinas, permitiéndoles actuar más rápida y efectivamente.","Hace que tengan un mejor sabor.","Algunas medicinas solo se pueden ingerir con agua","Se atraen."],
                    'answer': [1,0,1,0],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
...
'/test/testporciento':{
    'questions':  [{'id': 1324,
                    ...
                    'inline': 0 ,
                    'title': "Opcion multiple",
                    'question': "¿Que cantidad de agua constituye nuestro cuerpo?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Todo","dos tercios(2/3)","La mitad"],
                    'answer': [0,1,0],
                    'answer_text': "Una sustancia",
                    'hints': ["", ""]
                    },
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Que puede ocacionar una deshidratacion moderada?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Frio","Dolor de cabeza y mareo","Hambre"],
                    'answer': [0,1,0],
                    },
                    {
                    'id':1322,
                    ...
                    'inline': 1,
                    'title': "Opcion multiple",
                    'question': "¿Como ayuda a los organos vitales el agua?",
                    'can_check': "True",
                    'can_show': "True",
                    'can_hint': "True",
                    'options': ["Protege y amortigua.","Hace que tengan un mejor sabor.","Los hidrata"],
                    'answer': [1,0,0],
                    }
                    ],
    'intro':"""<h3>Evaluación</h3>
